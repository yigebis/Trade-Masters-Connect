...
$oldUsername = $custStatusRow['UserName'];
$credSql = "SELECT * FROM customer_credentials where UserName = '$username';";
...
if (isset($_FILES['fileImg']) && $_FILES['fileImg']['error'] === UPLOAD_ERR_OK) {
    ...
    if (move_uploaded_file($fileTmpName, $uploadPath)) {
        ...
        $sql = "UPDATE customer SET `Photo Link` = ? WHERE UserName = ?";
...
<body>
  <form method="post" action="customerUPP.php" enctype="multipart/form-data">
    <div class="Technician-container">
      <div class="profile">
        ...
        <div class="paragraph">
          <p id="Technician_UserName"><?php echo $custStatusRow['First Name'] . " " . $custStatusRow['Father Name'] . " " . $custStatusRow['Grand Father Name']; ?></p>
          <br>
        </div>
        ...
        <div class="technician-form">
          <div class="add-form">
            <div class="input-box">
              ...
              <input type="text" name="firstName" value="<?php echo isset($_POST['firstName']) ? htmlspecialchars($_POST['firstName']) : htmlspecialchars($custStatusRow['First Name']); ?>" />
              <i class='bx bxs-phone'></i>
            </div>
            <div class="input-box">
              <label for="middleName">Father Name</label>
              <input type="text" name="middleName" value="<?php echo isset($_POST['middleName']) ? htmlspecialchars($_POST['middleName']) : htmlspecialchars($custStatusRow['Father Name']); ?>" />
              <i class='bx bxs-phone'></i>
            </div>
            <div class="input-box">
              <label for="lastName">Grand Father Name</label>
              <input type="text" name="lastName" value="<?php echo isset($_POST['lastName']) ? htmlspecialchars($_POST['lastName']) : htmlspecialchars($custStatusRow['Grand Father Name']); ?>" />
              <i class='bx bxs-phone'></i>
            </div>
            <div class="input-box">
              <label for="change_phoneNumber">Phone Number</label>
              <input type="tel" id="change_phoneNumber" name="phoneNumber" value="<?php echo isset($_POST['phoneNumber']) ? htmlspecialchars($_POST['phoneNumber']) : htmlspecialchars($custStatusRow['Phone Number']); ?>" />
              <i class='bx bxs-phone'></i>
            </div>
