<?php
    ...
    function rejectRequest($techusername, $custusername, $skill, $date){
        ...
        $stmt -> bind_param("ss", $accept, $newDate);
                    ...
                    <?php while ($row = $result -> fetch_assoc()){ ?>
                        <li>
                            ...
                            <div class="right-detail">
                                <form action="rejected.php" method="post" onsubmit="viewConfirmAccept(event)">
                                    <button class="bg-green" type="submit" id="reject">Accept</button>
